...
const ResourceHub = () => {
  ...
  // Filter resources based on selected languages
  ...
  // Prepare resources for different categories
      ...
      <main className="container mx-auto px-6 py-16" id="resources">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Explore our carefully curated collection of mental wellness resources, 
            available in multiple languages to support your journey toward better mental health.
          </p>
        </div>
        ...
        <div className="mt-20 text-center bg-wellness-gradient p-12 rounded-3xl text-white shadow-wellness">
          <Heart className="w-16 h-16 mx-auto mb-6 opacity-80" />
          <h3 className="text-3xl font-bold mb-4">
            Your Mental Health Matters
          </h3>
          <p className="text-xl opacity-90 max-w-2xl mx-auto mb-6">
            Remember that seeking help is a sign of strength. These resources are here to support you, 
            but professional help should always be sought when needed.
          </p>
          <div className="text-lg opacity-80">
            <p>🌟 Available 24/7 • 🌍 Multiple Languages • 💙 Professional Quality</p>
          </div>
        </div>
      </main>
    </div>
